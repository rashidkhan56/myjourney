...
type StaticProjectsListProps = {
  projects: StaticProject[];
  viewMoreText?: string;
};

export default function StaticProjectsList({
  projects,
  viewMoreText = "View Project",
}: StaticProjectsListProps) {
    ...
    <div ref={component}>
          ...
          >
            ...
            >
              <div className="flex flex-col gap-2 md:gap-3">
                <span className="text-xl md:text-3xl font-bold leading-tight">{project.title}</span>
      ...
      <div
        ...
        style={{
          backgroundImage:
            currentItem !== null
              ? `url(${projects[currentItem].hoverImage})`
              : "",
        }}
        ref={revealRef}
      ></div>
